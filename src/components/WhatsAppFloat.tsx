...
const WhatsAppFloat = () => {
  ...
  return (
    <>
      {/* Floating WhatsApp Button - More Visible */}
      <button
        onClick={handleWhatsAppClick}
        className="fixed bottom-6 right-6 bg-whatsapp text-white w-20 h-20 rounded-full flex items-center justify-center shadow-2xl hover:shadow-whatsapp/50 transition-all duration-300 hover:scale-110 z-50 animate-pulse"
        aria-label="Contato via WhatsApp com Felipe"
      >
        <div className="absolute inset-0 bg-whatsapp rounded-full animate-ping opacity-30"></div>
        <svg
          className="w-10 h-10 transition-transform duration-300 relative z-10"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
