        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="scroll-fade-in">
            <div className="relative">
              ...
              />
              <div className="absolute inset-0 bg-champagne-gradient opacity-10 rounded-2xl"></div>
              <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-champagne-gradient rounded-full flex items-center justify-center text-midnight-900 font-bold text-xl shadow-2xl">
                FB
              </div>
            </div>
          </div>
          ...
          <div className="scroll-fade-in">
            <h2 className="subheading-luxury text-midnight-900 mb-6">
              Especialista em <span className="text-champagne-600">Luxo Exclusivo</span>
            </h2>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {awards.map((award, index) => (
                    <li key={index} className="flex items-center text-midnight-600">
                      <div className="w-4 h-4 text-champagne-500 mr-3">
            ...
            {/* Signature */}
            <div className="bg-champagne-50 p-6 rounded-lg border-l-4 border-champagne-500 mb-8">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-midnight-900 font-playfair text-xl font-semibold mb-1">
                    Felipe Botticelli
                  </p>
                  <p className="text-champagne-600 font-medium">
                ...
                <div className="text-champagne-500 text-4xl font-playfair font-bold">
                  FB
                </div>
              </div>
            </div>
