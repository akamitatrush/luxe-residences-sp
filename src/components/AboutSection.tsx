        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="scroll-fade-in">
            <div className="relative">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-br from-accent to-yellow-500 opacity-10 rounded-2xl"></div>
              <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-gradient-to-br from-accent to-yellow-500 rounded-full flex items-center justify-center text-black font-bold text-xl shadow-2xl">
                FB
              </div>
            </div>
          </div>
          ...
          <div className="scroll-fade-in">
            ...
            {/* Signature */}
            <div className="bg-secondary p-6 rounded-lg border-l-4 border-accent mb-8">
