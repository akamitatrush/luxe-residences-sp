      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16 scroll-fade-in">
          <h2 className="subheading-luxury text-platinum-100 mb-6">
            Sua Jornada para o <span className="text-gray-600">Lar dos Sonhos</span>
          </h2>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-16 left-full w-full h-px bg-gradient-to-r from-gray-400 to-transparent z-0"></div>
              )}
              
              <div className="relative z-10 text-center">
                {/* Number */}
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gray-600 rounded-full mb-6 text-white font-playfair font-bold text-xl">
                  {step.number}
                </div>
