    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        <h1 className="heading-luxury text-white mb-6 scroll-fade-in">
          Domínios de <span className="text-gray-300">Excelência</span> em São Paulo
        </h1>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 scroll-fade-in">
          <div className="flex flex-col items-center text-white/70">
            ...
            <div className="w-px h-16 bg-gray-300/50 animate-pulse"></div>
            <div className="w-2 h-2 bg-gray-300 rounded-full animate-bounce mt-2"></div>
          </div>
        </div>
      </div>
    </section>
